...
数据提取自 docs/各省数据2025/重庆.md，人工核对后固化于此；md 更新后请同步本脚本。
写入 frontend/public/data/{capacity,price,energy}.json（整省替换）。

用法:
    uv run python scripts/provinces/chongqing.py
"""
import json
...
CAPACITY = dict(year=2025, thermal_mw=16460, hydro_mw=6190, wind_mw=2600, pv_mw=1180, nuclear_mw=0, other_mw=1400, total_mw=27830, source_url=None)
...
ENERGY = [
    (0, 156700, None, None, None),  # 年度
    (3, 9320, None, None, None),
    (4, 9110, None, None, None),
    (5, 8960, None, None, None),
    (6, 14280, None, None, None),
    (7, 11210, None, None, None),
    (8, 11360, None, None, None),
    (12, 8180, None, None, None),]
...
ANNUAL_MLT = (458.33, 12)  # 年度中长期交易均价，重庆.md §三
