...
数据提取自 docs/各省数据2025/黑龙江.md，人工核对后固化于此；md 更新后请同步本脚本。
写入 frontend/public/data/{capacity,price,energy}.json（整省替换）。

用法:
    uv run python scripts/provinces/heilongjiang.py
"""
import json
from pathlib import Path

ROOT = Path(__file__).resolve().parents[2]
CODE, NAME = "230000", "黑龙江"
...
# ===== 装机（2025 年度，MW；来源：https://news.bjx.com.cn/html/20250506/1439979.shtml](https:/）=====
CAPACITY = dict(year=2025, thermal_mw=25170, hydro_mw=1010, wind_mw=15060, pv_mw=7160, nuclear_mw=0, other_mw=2950, total_mw=51350, source_url='https://news.bjx.com.cn/html/20250506/1439979.shtml](https://news.bjx.com.cn/html/20250506/1439979.shtml)、[https://www.chyxx.com/shuju/1233136.html](https://www.chyxx.com/shuju/1233136.html')
...
ENERGY = [
    (3, 11430, None, None, None),
    (4, 10460, None, None, None),
    (5, 9440, None, None, None),]
...
ANNUAL_MLT = (387.42, 12)  # 全年电力直接交易均价，黑龙江.md §三
