...
数据提取自 docs/各省数据2025/江西.md，人工核对后固化于此；md 更新后请同步本脚本。
写入 frontend/public/data/{capacity,price,energy}.json（整省替换）。

用法:
    uv run python scripts/provinces/jiangxi.py
"""
import json
...
ENERGY = [
    (0, 179900, None, None, None),  # 年度
    (12, 15490, None, None, None),]

# ===== 年度发电结构（GWh：火/水/风/光/核；None=未提供）=====
GEN_STRUCTURE = (147710, 6640, 13130, 12417, None)
