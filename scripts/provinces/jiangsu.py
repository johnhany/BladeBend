...
数据提取自 docs/各省数据2025/江苏.md，人工核对后固化于此；md 更新后请同步本脚本。
写入 frontend/public/data/{capacity,price,energy}.json（整省替换）。

用法:
    uv run python scripts/provinces/jiangsu.py
"""
import json
...
CAPACITY = dict(year=2025, thermal_mw=120000, hydro_mw=3000, wind_mw=25000, pv_mw=90000, nuclear_mw=7000, other_mw=0, total_mw=245000, source_url=None)

# ===== 电价（2025 年，元/MWh；None=未披露。行：(月, 现货, 中长期, 最高, 最低)。来源：None）=====
PRICES = [
    (3, 298.0, None, None, None),
    (5, None, 401.0, None, None),
    (6, None, 312.8, None, None),
    (7, None, 395.6, None, None),
    (8, None, 393.8, None, None),
    (9, None, 319.48, None, None),]

# ===== 电量（GWh；None=未披露。行：(月, 发电量, 用电量, 跨省受入, 跨省送出)。来源：None）=====
ENERGY = [
    (0, 708282, 889541, None, None),  # 年度
    (2, 49673, 62149, None, None),
    (3, 55566, 70406, None, None),
    (4, 52079, 64819, None, None),
    (5, 56117, 67499, None, None),
    (6, 56713, 73721, None, None),
    (7, 74608, 93298, None, None),
    (9, 62188, 80690, None, None),
    (10, 58423, 71586, None, None),
    (11, 56848, 68645, None, None),
    (12, 59348, 75596, None, None),]

# ===== 年度发电结构（GWh：火/水/风/光/核；None=未提供）=====
GEN_STRUCTURE = None
PRICE_LIMITS = {"default": {"spot": {"floor": 0, "cap": 1500}, "mlt": {"floor": 312.8}}}  # 江苏.md
