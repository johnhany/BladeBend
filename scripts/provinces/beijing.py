...
数据提取自 docs/各省数据2025/北京.md，人工核对后固化于此；md 更新后请同步本脚本。
写入 frontend/public/data/{capacity,price,energy}.json（整省替换）。

用法:
    uv run python scripts/provinces/beijing.py
"""
import json
...
CAPACITY = dict(year=2025, thermal_mw=11530, hydro_mw=991, wind_mw=300, pv_mw=2000, nuclear_mw=0, other_mw=550, total_mw=15371, source_url=None)
...
ENERGY = [
    (0, 43520, 144750, 90000, None),  # 年度（受入≈900亿kWh，2024基数2025同比增，md §四）
    (3, 3680, None, None, None),
    (4, 2280, None, None, None),
    (5, 2470, None, None, None),
    (6, 3450, None, None, None),
    (7, 4350, None, None, None),
    (8, 3960, None, None, None),
    (9, 2100, None, None, None),
    (10, 2370, None, None, None),
    (11, 4090, None, None, None),
    (12, 5270, None, None, None),]
...
ANNUAL_MLT = None
BENCHMARK = 359.8  # 燃煤基准价（元/MWh；北京.md §三）
