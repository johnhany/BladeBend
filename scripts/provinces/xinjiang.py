...
数据提取自 docs/各省数据2025/新疆.md，人工核对后固化于此；md 更新后请同步本脚本。
写入 frontend/public/data/{capacity,price,energy}.json（整省替换）。

用法:
    uv run python scripts/provinces/xinjiang.py
"""
import json
...
CAPACITY = dict(year=2025, thermal_mw=74190, hydro_mw=10750, wind_mw=54350, pv_mw=73010, nuclear_mw=0, other_mw=20150, total_mw=232450, source_url=None)
...
ENERGY = [
    (0, 530000, None, None, 141299),  # 年度（送出=外送合计，md §4.1）
    (5, 40940, None, None, None),
    (12, 57000, None, None, None),]
...
ANNUAL_MLT = (263.47, 5)  # 省间外送交易 1-5月均价（外送口径），新疆.md §三
