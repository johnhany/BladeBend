...
数据提取自 docs/各省数据2025/上海.md，人工核对后固化于此；md 更新后请同步本脚本。
写入 frontend/public/data/{capacity,price,energy}.json（整省替换）。

用法:
    uv run python scripts/provinces/shanghai.py
"""
import json
...
CAPACITY = dict(year=2025, thermal_mw=13348, hydro_mw=0, wind_mw=1500, pv_mw=2000, nuclear_mw=0, other_mw=0, total_mw=16848, source_url=None)
...
ENERGY = [
    (0, None, 208888, None, None),  # 年度
]

# ===== 年度发电结构（GWh：火/水/风/光/核；None=未提供）=====
GEN_STRUCTURE = (None, None, 8372, 6307, None)
