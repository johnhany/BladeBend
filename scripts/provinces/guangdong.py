...
数据提取自 docs/各省数据2025/广东.md，人工核对后固化于此；md 更新后请同步本脚本。
写入 frontend/public/data/{capacity,price,energy}.json（整省替换）。

用法:
    uv run python scripts/provinces/guangdong.py
"""
import json
...
CAPACITY = dict(year=2025, thermal_mw=124342, hydro_mw=0, wind_mw=39950, pv_mw=39780, nuclear_mw=16140, other_mw=11485, total_mw=231697, source_url=None)
...
# 仅全年累计用电量已披露（958,973 GWh，广东电网）；逐月与发电量未公开。来源：广东.md §二）=====
ENERGY = [
    (0, None, 958973, 261600, None),  # 年度（受入=西电等年度总量，md §4.2）
]
...
ANNUAL_MLT = (384.0, 6)  # 1-6月中长期累计均价，广东.md §三
