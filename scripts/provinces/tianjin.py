...
数据提取自 docs/各省数据2025/天津.md，人工核对后固化于此；md 更新后请同步本脚本。
写入 frontend/public/data/{capacity,price,energy}.json（整省替换）。

用法:
    uv run python scripts/provinces/tianjin.py
"""
import json
...
CAPACITY = dict(year=2025, thermal_mw=17000, hydro_mw=5, wind_mw=2635, pv_mw=7533, nuclear_mw=0, other_mw=334, total_mw=27507, source_url=None)
...
ANNUAL_MLT = (433.58, 12)  # 年度长协均价，天津.md §三
BENCHMARK = 365.5  # 燃煤基准价（元/MWh；天津.md §三）
