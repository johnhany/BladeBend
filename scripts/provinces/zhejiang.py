...
数据提取自 docs/各省数据2025/浙江.md，人工核对后固化于此；md 更新后请同步本脚本。
写入 frontend/public/data/{capacity,price,energy}.json（整省替换）。

用法:
    uv run python scripts/provinces/zhejiang.py
"""
import json
...
# ===== 装机（2025 年度，MW；来源：http://zj.people.com.cn/n2/2026/0202/c186327-41490402.html、h）=====
CAPACITY = dict(year=2025, thermal_mw=80000, hydro_mw=27000, wind_mw=0, pv_mw=59000, nuclear_mw=9000, other_mw=0, total_mw=175000, source_url='http://zj.people.com.cn/n2/2026/0202/c186327-41490402.html、https://www.88cc88.com/electricity-overview/show-743.html')
...
# ===== 电量（GWh；None=未披露。行：(月, 发电量, 用电量, 跨省受入, 跨省送出)。来源：http://zj.people.com.cn/n2/2026/0121/c370990-41478912.html、https://www.cpnn.com.cn/news/dianli2023/202601/t20260126_1862748.html）=====
ENERGY = [
    (0, 4918, 7266, None, None),  # 年度
    (3, None, 581, None, None),
    (4, None, 536, None, None),
    (9, None, 713, None, None),]

# ===== 年度发电结构（GWh：火/水/风/光/核；None=未提供）=====
GEN_STRUCTURE = None
PRICE_LIMITS = {"default": {"spot": {"floor": -200, "cap": 1200}}}  # 浙江.md（结算限值）

ANNUAL_SPOT = None  # 官方年度均价 (值, 样本月数)，如 (277.56, 4)；None=未披露
ANNUAL_MLT = (390.69, 12)  # 全年省内中长期净交易均价，浙江.md §三
...
def main() -> None:
    ...
    for month, gen, cons, recv, sent in ENERGY:
        it = dict(province_code=CODE, province_name=NAME, year=2025, month=month,
                  ...
                  source_url='http://zj.people.com.cn/n2/2026/0121/c370990-41478912.html、https://www.cpnn.com.cn/news/dianli2023/202601/t20260126_1862748.html')
