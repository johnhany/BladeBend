...
数据提取自 docs/各省数据2025/吉林.md，人工核对后固化于此；md 更新后请同步本脚本。
写入 frontend/public/data/{capacity,price,energy}.json（整省替换）。

用法:
    uv run python scripts/provinces/jilin.py
"""
import json
...
# ===== 装机（2025 年度，MW；来源：http://www.cpicu.org.cn/cnt_4561.html、https://news.cnjiwang.）=====
CAPACITY = dict(year=2025, thermal_mw=17500, hydro_mw=6540, wind_mw=18000, pv_mw=8070, nuclear_mw=0, other_mw=1633, total_mw=51743, source_url='http://www.cpicu.org.cn/cnt_4561.html、https://news.cnjiwang.com/jwyc/202602/4022764.html、https://guangfu.bjx.com.cn/news/20221108/1267010.shtml')
...
# ===== 电量（GWh；None=未披露。行：(月, 发电量, 用电量, 跨省受入, 跨省送出)。来源：https://tjgb.hongheiku.com/sjtjgb/69683.html、https://m.bjx.com.cn/mnews/20260130/1482101.shtml、https://www.cpem.org.cn/list2/114120.html）=====
ENERGY = [
    (0, 1196, 1012, None, None),  # 年度
    (1, 104, 94, None, None),
    (2, 88, 84, None, None),
    (3, None, 88, None, None),
    (4, None, 74, None, None),
    ...
    (8, 100, 82, None, None),
    (9, 44, 75, None, None),
    (10, None, 84, None, None),
    (11, None, 91, None, None),
    (12, 107, 104, None, None),]
...
ANNUAL_MLT = (391.67, 12)  # 发电侧全年结算均价，吉林.md §三
...
def main() -> None:
    ...
    for month, gen, cons, recv, sent in ENERGY:
        it = dict(province_code=CODE, province_name=NAME, year=2025, month=month,
                  ...
                  source_url='https://tjgb.hongheiku.com/sjtjgb/69683.html、https://m.bjx.com.cn/mnews/20260130/1482101.shtml、https://www.cpem.org.cn/list2/114120.html')
