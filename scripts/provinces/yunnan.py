...
数据提取自 docs/各省数据2025/云南.md，人工核对后固化于此；md 更新后请同步本脚本。
写入 frontend/public/data/{capacity,price,energy}.json（整省替换）。

用法:
    uv run python scripts/provinces/yunnan.py
"""
import json
...
CAPACITY = dict(year=2025, thermal_mw=0, hydro_mw=80000, wind_mw=18000, pv_mw=70000, nuclear_mw=0, other_mw=0, total_mw=168000, source_url=None)
...
ENERGY = [
    (0, 459605, 292538, None, 192500),  # 年度（送出=全年净输出，md §四）
    (3, 32420, None, None, None),
    (6, 43894, None, None, None),
    (9, 50634, None, None, None),
    (12, 34090, None, None, None),]
...
ANNUAL_MLT = None
BENCHMARK = 335.8  # 燃煤基准价（元/MWh；云南.md §三）
